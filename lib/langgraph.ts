...
// Customers dummy api : https://introspection.apis.stepzen.com/customers/
// comments api: https://dummyjson.com/comments
...
const initialiseModel = () => {
    const model = new ChatAnthropic({
      modelName: "claude-3-5-haiku-20241022", //alternative model: "claude-3-haiku-20240307" but poor performance
